var Sketch = function() {
    function e(e) {
        ...
        return s.canvas = u, u.className = "sketch", o ? e.autoresize = !1 : (e.container1.appendChild(u), e.hasOwnProperty("autoresize") || (e.autoresize = l.autoresize), u.id = t), n(self, g), n(s, e), n(s, p), a(), e.autoresize && i(), w.push(s), s.autostart && setTimeout(s.start, 0), s
    }
    ...
    var s, r = 0,
        ...
        p = {
            ...
            destroy: function() {
                ...
                s.container1.removeChild(s.canvas);
